...
- Check `.sc4sap/cbo/<MODULE>/<PACKAGE>/inventory.json`.
  ...
  - **Missing** → Print one line: "No CBO inventory at `.sc4sap/cbo/<MODULE>/<PACKAGE>/`. Run `/sp4sap:analyze-cbo-obj` first for richer spec annotations, or type `skip` to proceed."
